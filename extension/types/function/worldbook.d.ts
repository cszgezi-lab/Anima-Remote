 ...
 */
declare function rebindGlobalWorldbooks(
  worldbook_names: string[],
): Promise<void>;
 ...
 * @returns 角色卡绑定的世界书
 */
declare function getCharWorldbookNames(
...
declare function rebindCharWorldbooks(
  ...
  char_worldbooks: CharWorldbooks,
): Promise<void>;
 ...
 */
declare function rebindChatWorldbook(
  chat_name: "current",
 ...
 */
declare function getOrCreateChatWorldbook(
  chat_name: "current",
  worldbook_name?: string,
): Promise<string>;
 ...
 */
declare function createWorldbook(
  worldbook_name: string,

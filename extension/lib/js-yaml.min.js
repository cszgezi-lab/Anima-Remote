...
!(function (e, t) {
    ...
    var ue = {
        YAML: function (e, t, n) {
            ...
            (null !== e.version && ce(e, "duplication of %YAML directive"),
                1 !== n.length &&
                    ce(e, "YAML directive accepts exactly one argument"),
                ...
                1 !== o &&
                    2 !== o &&
                    se(e, "unsupported YAML version of the document"));
        },
        TAG: function (e, t, n) {
            var i, r;
            (2 !== n.length &&
                ce(e, "TAG directive accepts exactly two arguments"),
                (i = n[0]),
                (r = n[1]),
                G.test(i) ||
                    ce(
    ...
    function pe(e, t, n, i) {
        ...
        if (t < n) {
            if (((l = e.input.slice(t, n)), i))
                ...
                W.test(l) &&
                    ce(e, "the stream contains non-printable characters");
            e.result += l;
        }
    }
    function fe(e, t, i, r) {
    ...
    function de(e, t, n, i, r, o, a, l, c) {
        ...
        if (Array.isArray(r))
            for (
                s = 0, u = (r = Array.prototype.slice.call(r)).length;
                s < u;
                s += 1
            )
                (Array.isArray(r[s]) &&
    ...
    function Ae(e) {
        ...
        i &&
            !V.test(i) &&
            ce(e, "tag name cannot contain such characters: " + i);
        try {
                ...
                i && 0 !== e.dump.length
                    ...
                    : (!(function (e, t, n) {
                          ...
                          for (i = 0, r = n.length; i < r; i += 1)
                              ((o = n[i]),
                                  e.replacer &&
                                      (o = e.replacer.call(n, String(i), o)),
                                  (Ve(e, t, o, !1, !1) ||
                                      (void 0 === o &&
                                          Ve(e, t, null, !1, !1))) &&
                                      ("" !== a &&

(function (global, factory) {
    ...
    class ZodError extends Error {
        ...
        get message() {
            return JSON.stringify(
                this.issues,
                exports.util.jsonStringifyReplacer,
                2,
            );
        }
        get isEmpty() {
        ...
        get isInt() {
            return !!this._def.checks.find(
                (ch) =>
                    ch.kind === "int" ||
                    (ch.kind === "multipleOf" &&
                        exports.util.isInteger(ch.value)),
            );
        }
        get isFinite() {
            let max = null,
                ...
                ...(message !== undefined
                    ? {
                          errorMap: (issue, ctx) => {
                              ...
                              const defaultError =
                                  (_c =
                                      (_b = (_a = this._def).errorMap) ===
                                          null || _b === void 0
                                          ? void 0
                                          : _b.call(_a, issue, ctx).message) !==
                                      null && _c !== void 0
                                      ? _c
                                      : ctx.defaultError;
    ...
    class ZodNativeEnum extends ZodType {
        _parse(input) {
            const nativeEnumValues = exports.util.getValidEnumValues(
                this._def.values,
            );
            const ctx = this._getOrReturnCtx(input);
            if (
                ...
                const expectedValues =
                    exports.util.objectValues(nativeEnumValues);
                addIssueToContext(ctx, {
                    expected: exports.util.joinValues(expectedValues),
                    received: ctx.parsedType,
                    code: ZodIssueCode.invalid_type,
    ...
    class ZodEffects extends ZodType {
        ...
        sourceType() {
            return this._def.schema._def.typeName ===
                exports.ZodFirstPartyTypeKind.ZodEffects
